...
function Enquirysection() {
  return (
     <section className="w-full bg-white text-white py-24 px-6 md:px-16 flex justify-center font-optima">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          ...
          <div className="flex flex-col gap-8">
            ...
            <input 
              type="text" 
              placeholder="Name" 
              className="w-full bg-transparent border-b border-gray-600 pb-3 text-sm focus:outline-none focus:border-[#d09e31] transition-colors placeholder:text-gray-400"
            />
            ...
            <div className="mt-4 border border-gray-700 bg-white p-3 flex items-center justify-between w-[300px] rounded-sm">
              <div className="flex items-center gap-3">
                <input type="checkbox" className="w-6 h-6 border-gray-500 rounded-sm cursor-pointer accent-green-500" />
                <span className="text-sm text-gray-700">Im not a robot</span>
              </div>
          ...
          <div className="relative w-full h-[250px] md:h-[350px]">
            ...
            <textarea 
              placeholder="Message" 
              className="w-full h-full bg-transparent border border-gray-600 p-5 text-sm focus:outline-none focus:border-[#d09e31] transition-colors resize-none placeholder:text-gray-400"
            ></textarea>

            {/* Overlapping Circular Submit Button */}
            <button className="absolute -bottom-8 -right-4 md:-bottom-12 md:-right-12 w-28 h-28 md:w-36 md:h-36 rounded-full border border-black flex items-center justify-center bg-black text-white hover:bg-black hover:text-black transition-all duration-500 z-10 overflow-hidden group">
